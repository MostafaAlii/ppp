...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin']], function () {
    Route::prefix('dashboard')->group(function () {
        ...
        Route::prefix('cms')->group(function () {
            Route::resource('advantages', Cms\AdvantagesController::class);
            Route::resource('price', Cms\PriceController::class);
            Route::resource('tour', Cms\TourController::class);
            Route::resource('faq', Cms\FaqController::class);
            Route::resource('contact', Cms\ContactController::class);
            Route::resource('about', Cms\AboutController::class);
            Route::resource('offer', Cms\OfferController::class);
            Route::resource('term', Cms\TermController::class);
            Route::resource('privacy', Cms\PrivacyController::class);
            Route::resource('copyright', Cms\CopyrightController::class);


            Route::prefix('examples')->group(function () {
                Route::get('/', [Cms\ExampleController::class, 'index'])->name('admin.example');
                Route::post('store',[Cms\ExampleController::class, 'store'])->name('admin.example.store');
                Route::post('update/{id}',[Cms\ExampleController::class, 'update'])->name('admin.example.update');
                Route::post('delete/{id}',[Cms\ExampleController::class, 'destroy'])->name('admin.example.destroy');
                Route::get('images/{id}',[Cms\ExampleController::class, 'addImages'])->name('admin.example.images');
                Route::post('image',[Cms\ExampleController::class, 'saveExampleImages'])->name('admin.example.images.store');
                Route::post('images/db',[Cms\ExampleController::class, 'saveExampleImagesDB'])->name('admin.example.images.store.db');
                Route::delete('{example_id}/image/{image_id}', [Cms\ExampleController::class, 'destroyMedia'])->name('admin.example.image.destroy');
            });
        });
    });
});
