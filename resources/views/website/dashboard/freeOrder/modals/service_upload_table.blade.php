<div class="service_media_details">
    <form action="{{ route('website.free-order.update_details', $order->id) }}" method="POST"
                ...
                <div class="row service_row" data-service-name="{{ $service->name }}">
                    <div class="col-md-6 col-sm-12">
                        <div class="photos-cont main-photos-cont">
                            <input class="photo-upload-input" data-service-name="{{ $service->name }}" type="file"
                                id="{{ $service->name }}" data-service="1" name="{{ $service->name }}_img[]" multiple
                                required />
                            <div class="photos-bg">
                        ...
                        <div class="photos-cont services-refs-cont">
                            <input class="photo-upload-input service_upload" id="{{ $service->name }}" type="file"
                                data-service="1" name="{{ $service->name }}_refs_img[]" multiple />
                            <div class="photos-bg">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <textarea name="notes[]" id="{{ $service->name }}-ins"
                            placeholder="Describe your requests briefly and in detail only according to the selected service."
                            required></textarea>
