...
<div style="width:1000px;height:100%;margin:auto;font-family:Arial;font-size:12px;" bis_skin_checked="1">
  ...
  <table width="975" border="0">
      ...
      <tr>
        <td width="87">
          <div align="left" bis_skin_checked="1">
            <br>
            <a href="{{route('website.tour.step_two')}}">
        ...
        <td width="789">
            <div align="center" bis_skin_checked="1">
              <br>
            <span class="style45">{{$step_three?->name}}</span>
          </div>
        </td>
        <td width="85">
          <div align="right" bis_skin_checked="1">
            <br>
            <a href="{{route('website.tour.video')}}" bis_skin_checked="1">
    ...
    <tr>
      <td height="465">&nbsp;</td>
      <td><div align="center" bis_skin_checked="1"><img src="{{ asset($step_three->ImagePath()) }}" width="850" height="616" alt="{{$step_three?->name}}"></div></td>
      <td>&nbsp;</td>
    </tr>
  </tbody>
  </table>
