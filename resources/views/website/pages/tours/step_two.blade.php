...
<div style="width:1000px;height:100%;margin:auto;font-family:Arial;font-size:12px;" bis_skin_checked="1">
  ...
  <table width="975" border="0">
      ...
      <tr>
        ...
        <td width="789">
            <div align="center" bis_skin_checked="1">
              <br>
            <span class="style45">{{$step_two?->name}}</span>
          </div>
        </td>
        <td width="85">
          <div align="right" bis_skin_checked="1">
            <br>
            <a href="{{route('website.tour.step_three')}}" bis_skin_checked="1">
    ...
    <tr>
      <td height="465">&nbsp;</td>
      <td><div align="center" bis_skin_checked="1"><img src="{{ asset($step_two->ImagePath()) }}" width="850" height="616" alt="{{$step_two?->name}}"></div></td>
      <td>&nbsp;</td>
    </tr>
  </tbody>
  </table>
