...
<div class="trowsection">
  <div class="container">
    <div class="text-center row justify-content-between align-items-start p-4 " style="background-color: #e9e9e9">
      @forelse ($icons as $key => $icon)
      <!--<div class="@if($key == 0 || $key == 2) col-lg-3 @endif @if($key == 1 || $key == 3 || $key == 4) col-lg-2 @endif col-md-6 col-sm-6 col-xs-6 wow fadeInUp"-->
      <div class="@if($key == 0 || $key == 1) col-lg-3 col-md-6 col-12 @endif @if($key == 2 || $key == 3 || $key == 4) col-lg-2 col-md-6 col-12 @endif wow fadeInUp"

        data-wow-delay="0.1s">
        <div class="rounded service-item">
      ...
      <div class="clearfix content-wrap" style="padding: 0 0 10px 0 !important">
        ...
        <div class="block-expand-categories flex-column flex-lg-row d-flex justify-content-center">
          ...
          <div class="expand-category bg-light" style="background-image: url({{ $service->ImagePath() }})">
            <a href="{{$service?->url}}"><h4 style="color: #1abc9c">{{ $service?->name }}</h4></a>
          </div>
          @empty
          <div class="col-md-12">
            <div class="d-flex justify-content-center align-items-center">
