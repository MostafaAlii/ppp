                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <div class="mx-auto col-md-9">
                                                        ...
                                                        <input class="form-control img" name="" type="file" accept="image/*" multiple>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <div class="mx-auto col-md-9">
                                                        ...
                                                        <input class="form-control border-primary" placeholder="Type Title" type="text" class="form-control"id="home_compression_title">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
