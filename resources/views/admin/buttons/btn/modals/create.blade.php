                ...
                <form action="{{ route('button.store') }}" method="POST">
                    ...
                    <div class="p-1 form-group">
                        ...
                        <select name="type" id="type" class="form-control">
                            ...
                            <option value="offer_contact" {{ old('type')=='offer_contact' ? 'selected' : '' }}>Offer-Contact</option>
                        </select>
                        @error('type')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="p-1 form-group" id="typePaymentsGroup">
                        ...
                        <select name="typePaymernts" id="typePayments" class="form-control">
                            ...
                            <option value="paypal" {{ old('typePaymernts')=='paypal' ? 'selected' : '' }}>PayPal
                            </option>
                            <option value="checkout" {{ old('typePaymernts')=='checkout' ? 'selected' : '' }}>2Checkout
                            </option>
                        </select>
                        @error('typePaymernts')
                        <div class="alert alert-danger">{{ $message }}</div>
