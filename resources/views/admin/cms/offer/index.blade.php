        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('offer.index') }}">{{ ucfirst($title) }}</a>
                    </li>
                </ol>
            </div>
        </div>
...
<div class="content-wrapper">
    <div class="content-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="ml-auto">
                    <a data-target="#create_offer" data-toggle="modal" data-effect="effect-scale"
        ...
        @include('admin.cms.offer.btn.modals.create')
        <!-- End Table -->
    </div>
</div>
@endsection
