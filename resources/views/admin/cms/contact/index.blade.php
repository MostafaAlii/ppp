        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('contact.index') }}">{{ ucfirst($title) }}</a></li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="content-wrapper">
    <div class="content-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="ml-auto">
                    <a data-target="#create_contact" data-toggle="modal"  data-effect="effect-scale" class="btn btn-success btn-sm">
        ...
        @include('admin.cms.contact.btn.modals.create')
        <!-- End Table -->
    </div>
</div>
@endsection
