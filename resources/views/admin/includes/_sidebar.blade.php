        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item has-sub">
                <a href="#" class="waves-effect waves-dark">
                    ...
                    <span class="menu-title" data-i18n="Menu levels">CMS Managment</span>
                </a>
                <ul class="menu-content" style="">
                    <!-- Start Price & Advantages -->
                    <li class="has-sub">
                        <a class="menu-item waves-effect waves-dark" href="#">
                            <i class="material-icons"></i>
                            <span data-i18n="Second level child">Price Page</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                                <a class="menu-item waves-effect waves-dark" href="{{route('advantages.index')}}">
                                    <i class="material-icons"></i>
                                    <span data-i18n="Third level">Advantages</span>
                                </a>
                            </li>
                            <li>
                                <a class="menu-item waves-effect waves-dark" href="{{route('price.index')}}">
                                    <i class="material-icons"></i>
                                    <span data-i18n="Third level">Price</span>
                                </a>
                            </li>
                        </ul>
                        <!-- Start Examples -->
                        <li class="has-sub">
                            <a class="menu-item waves-effect waves-dark" href="#">
                                <i class="material-icons"></i>
                                <span data-i18n="Second level child">Examples Page</span>
                            </a>
                            <ul class="menu-content">
                                <li>
                                    <a class="menu-item waves-effect waves-dark" href="{{route('admin.example')}}">
                                        <i class="material-icons"></i>
                                        <span data-i18n="Third level">Examples</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <!-- End Price & Advantages -->
                    <ul class="menu-content">
                        <li>
                            <a class="menu-item waves-effect waves-dark" href="{{route('tour.index')}}">
                                <i class="material-icons"></i>
                                <span data-i18n="Third level">Tours</span>
                            </a>
                        </li>
                    </ul> 
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="menu-item waves-effect waves-dark" href="{{route('faq.index')}}">
                                <i class="material-icons"></i>
                                <span data-i18n="Third level">Faqs</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="menu-item waves-effect waves-dark" href="{{route('contact.index')}}">
                                <i class="material-icons"></i>
                                <span data-i18n="Third level">Contact</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="menu-item waves-effect waves-dark" href="{{route('about.index')}}">
                                <i class="material-icons"></i>
                                <span data-i18n="Third level">About</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="menu-item waves-effect waves-dark" href="{{route('offer.index')}}">
                                <i class="material-icons"></i>
                                <span data-i18n="Third level">Offer</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="menu-item waves-effect waves-dark" href="{{route('term.index')}}">
                                <i class="material-icons"></i>
                                <span data-i18n="Third level">Terms</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="menu-item waves-effect waves-dark" href="{{route('privacy.index')}}">
                                <i class="material-icons"></i>
                                <span data-i18n="Third level">Privacy</span>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="menu-content">
                        <li>
                            <a class="menu-item waves-effect waves-dark" href="{{route('copyright.index')}}">
                                <i class="material-icons"></i>
                                <span data-i18n="Third level">Copyright</span>
                            </a>
                        </li>
                    </ul>
                </ul>
